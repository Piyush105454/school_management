      ...
      if (initialData) {
        ...
        if (initialData.parentsGuardians && initialData.parentsGuardians.length > 0) {
          ...
          if (singleParent) {
            ...
            // If both exist but no isSingleParent flag, check count
      ...
      try {
        ...
        reader.onloadend = async () => {
          try {
            ...
            // Filter parents based on selection before saving if needed, 
            // but usually we save the whole array and backend handles it.
            // For now let's just save the whole array.
