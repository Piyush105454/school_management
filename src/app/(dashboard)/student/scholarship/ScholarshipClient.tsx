                      ...
                      <td className="px-4 py-3 text-center">
                        {record.status !== "PAID" && pendingDue > 0 ? (
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-black text-xs px-3 py-1.5 rounded-lg border border-emerald-200 transition duration-150 cursor-pointer border-0"
        ...
        <div className="p-8 overflow-y-auto flex-1 space-y-6 relative" id="invoice-print-area">
          ...
          <div className="grid grid-cols-2 gap-6 bg-slate-50 border border-slate-100 p-5 rounded-2xl">
            <div className="space-y-1">
              ...
              <p className="text-sm font-black text-slate-800">{record.name || "Student"}</p>
          ...
          <div className="flex justify-between items-end pt-12 text-[10px] text-slate-400 font-medium">
            <div>
              <p>Generated by: Student Portal</p>
